...
public class EPrecompiledContracts {
  ...
  private static final DataWord ripemd160Addr = new DataWord(
  ...
  public static PrecompiledContract getContractForAddress(DataWord address) {
    ...
    if (address.equals(ripemd160Addr)) {
      return ripemd160;
    }
  ...
  public static class Ripemd160 extends PrecompiledContract {
