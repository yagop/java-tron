...
@Slf4j(topic = "capsule")
public class StorageRowCapsule implements ProtoCapsule<Protocol.ByteArray> {
  ...
  public Protocol.ByteArray getInstance() {
    return Protocol.ByteArray.newBuilder().setData(ByteString.copyFrom(rowValue)).build();
  }
